...
export const initCommand: SlashCommand = {
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are AIRA, an AI research assistant. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
