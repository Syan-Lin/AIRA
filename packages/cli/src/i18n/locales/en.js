...
export default {
  ...
  'Configure MinerU token': 'Configure MinerU token',
  'Configure AMiner token': 'Configure AMiner token',
  Done: 'Done',
  'Add new API key': 'Add new API key',
  Delete: 'Delete',
  'Select API key format': 'Select API key format',
  ...
  'Token saved successfully.': 'Token saved successfully.',
