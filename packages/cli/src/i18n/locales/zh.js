...
export default {
  ...
  WITTY_LOADING_PHRASES: [
    // --- 实验室日常 ---
    '正在跑第 101 次对照实验，这次一定显著...',
    '导师正在身后，服务器都不敢偷懒...',
    'Western Blot 在转膜，数据在加载...',
    '正在用移液枪给 GPU 加样，请稍候...',
    '细胞还在培养，结果出来前先等等...',

    // --- 论文与投稿 ---
    'Reviewer 2 正在审阅这段代码，压力拉满...',
    '正在把 p=0.051 修成 p=0.049，魔法加载中...',
    'Paper 正在从 Major Revision 飞向 Accept...',
    '参考文献格式还没调好，先加载一会儿...',
    'Fig.1 的配色正在审美挣扎中...',
    ...
    '只要我不查重，重复率就是 0%...',
    '头发和 p 值一样，都在掉...',
    'Nobel 奖委员会正在开会讨论我的加载速度...',
    '正在把阴性结果包装成阳性发现...',
    '去年的protocol已经找不到了，正在凭感觉加载...',

    // --- 数据与计算 ---
    '服务器正在深度学习如何不崩溃...',
    '数据已经显著了，只是在等显著性水平同意...',
    '正在用 Excel 处理大数据，勇气可嘉...',
    'Grant 申请书写到一半，先加载点灵感...',
    'Python 正在 import 整个宇宙，请耐心等待...',
