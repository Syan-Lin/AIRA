...
export default {
  ...
  WITTY_LOADING_PHRASES: [
    // --- 实验室日常 ---
    '正在跑第 101 次消融实验，这次一定涨点...',
    '导师正在身后，GPU 都不敢掉利用率...',
    '数据集正在解压，灵感在加载...',
    '正在用 pip 给服务器投喂环境包，请稍候...',
    '模型还在收敛，结果出来前先等等...',

    // --- 论文与投稿 ---
    'Reviewer 2 正在审阅这段代码，压力拉满...',
    '正在把 Accuracy 0.512 修成 SOTA，魔法加载中...',
    'Paper 正在从 Reject 飞向 Accept (Hopefully)...',
    'LaTeX 编译还没过，参考文献在打架...',
    'Figure 2 的 Loss 曲线正在努力变得平滑...',

    // --- 学术自嘲 ---
    '只要我不跑 baseline，我就是 baseline...',
    '头发和 learning rate 一样，都在衰减...',
    'NeurIPS 审稿人正在开会讨论我的加载速度...',
    '正在把负样本包装成 Hard Negative...',
    '去年的 checkpoint 已经找不到了，正在凭记忆加载...',

    // --- 数据与训练 ---
    '服务器正在深度学习如何不 CUDA OOM...',
    '梯度已经下降了，只是在等早停策略同意...',
    '正在用 Excel 画神经网络，勇气可嘉...',
    '基金申请书写到 Related Work，先加载点灵感...',
    'Python 正在 import 整个深度学习宇宙，请耐心等待...',
    ...
    '别急，Loss 总是需要一点时间来收敛...',
    '愿你的实验可复现，愿你的消融不被质疑...',
    '哪怕只有 0.1% 的进度，也是在向 Best Paper 靠近...',
  ],
